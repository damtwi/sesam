...
! Compute order of variables fields in 'czon' file
         DO jdta1=1,dtaend1
            ...
            ! IF (.NOT. affect) THEN
            !    PRINT *, 'ERROR 103: variable not found?'
            !    PRINT *, '  jdta1 = ', jdta1
            !    PRINT *, '  dtaend1 = ', dtaend1
            !    PRINT *, '  nbvar = ', nbvar
            !    PRINT *, '  dta_ord1 = ', dta_ord1
            !    PRINT *, '  dta_nam1 = ', dta_nam1
            !    PRINT *, '  Available dta_nam:'
            !    DO inddta = 1, nbvar
            !       PRINT *, '   ', inddta, ' : "', TRIM(dta_nam(inddta)), '"'
            !    END DO
            !    DO inddta = 1, dtaend1
            !       PRINT *, '   ', inddta, ' : "', TRIM(dta_nam1(inddta)), '"'
            !    END DO
            !    GOTO 103
            ! END IF
